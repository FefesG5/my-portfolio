            ...
            <div key={group.category}>
              ...
              <div className="flex flex-wrap gap-3">
                {group.skills.map((skill) => (
                  <span
                    key={skill}
                    className="px-4 py-2 bg-gray-900 dark:bg-gray-700 text-white rounded-full text-sm font-medium hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors cursor-default brutalist:bg-black brutalist:rounded-none brutalist:border-2 brutalist:border-black"
                  >
                    {skill}
                  </span>
                ))}
